...
class __Mustache_5b798f31f639ffaf09e459381f851d1f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section51f065ea1bebdc6435c5f55642a4da15($context, $indent, $value);
...
';
    ...
    private function section1775afaa69045fc3934d493f48b6f903(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section51f065ea1bebdc6435c5f55642a4da15(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= '</div>
';
                $buffer .= $indent . '                            <button class="btn btn-sm cb-btnsort dir-none ml-auto" data-string="uses" data-action="sortuses"
';
                $buffer .= $indent . '                            title="';
                // 'str' section
                $value = $context->find('str');
...
';
                ...
                $buffer .= $this->section1775afaa69045fc3934d493f48b6f903($context, $indent, $value);
                $buffer .= $indent . '                </div>
';
                $context->pop();
            }
