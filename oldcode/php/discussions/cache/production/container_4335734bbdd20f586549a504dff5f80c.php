...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'phpbb_discussions_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php', 'phpbb_discussions_forums', 'phpbb_discussions_posts', 'phpbb_discussions_topics', 'phpbb_discussions_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbb_discussions_captcha_questions', 'phpbb_discussions_captcha_answers', 'phpbb_discussions_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'phpbb_discussions_ext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager(${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'}, 'phpbb_discussions_modules', './', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'phpbb_discussions_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'phpbb_discussions_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_bbcodes', 'phpbb_discussions_smilies', 'phpbb_discussions_styles', 'phpbb_discussions_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_discussions_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'phpbb_discussions_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'phpbb_discussions_acl_groups',
            'tables.acl_options' => 'phpbb_discussions_acl_options',
            'tables.acl_roles' => 'phpbb_discussions_acl_roles',
            'tables.acl_roles_data' => 'phpbb_discussions_acl_roles_data',
            'tables.acl_users' => 'phpbb_discussions_acl_users',
            'tables.attachments' => 'phpbb_discussions_attachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbb_discussions_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbb_discussions_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbb_discussions_oauth_accounts',
            'tables.banlist' => 'phpbb_discussions_banlist',
            'tables.bbcodes' => 'phpbb_discussions_bbcodes',
            'tables.bookmarks' => 'phpbb_discussions_bookmarks',
            'tables.bots' => 'phpbb_discussions_bots',
            'tables.captcha_qa_questions' => 'phpbb_discussions_captcha_questions',
            'tables.captcha_qa_answers' => 'phpbb_discussions_captcha_answers',
            'tables.captcha_qa_confirm' => 'phpbb_discussions_qa_confirm',
            'tables.config' => 'phpbb_discussions_config',
            'tables.config_text' => 'phpbb_discussions_config_text',
            'tables.confirm' => 'phpbb_discussions_confirm',
            'tables.disallow' => 'phpbb_discussions_disallow',
            'tables.drafts' => 'phpbb_discussions_drafts',
            'tables.ext' => 'phpbb_discussions_ext',
            'tables.extensions' => 'phpbb_discussions_extensions',
            'tables.extension_groups' => 'phpbb_discussions_extension_groups',
            'tables.forums' => 'phpbb_discussions_forums',
            'tables.forums_access' => 'phpbb_discussions_forums_access',
            'tables.forums_track' => 'phpbb_discussions_forums_track',
            'tables.forums_watch' => 'phpbb_discussions_forums_watch',
            'tables.groups' => 'phpbb_discussions_groups',
            'tables.icons' => 'phpbb_discussions_icons',
            'tables.lang' => 'phpbb_discussions_lang',
            'tables.log' => 'phpbb_discussions_log',
            'tables.login_attempts' => 'phpbb_discussions_login_attempts',
            'tables.migrations' => 'phpbb_discussions_migrations',
            'tables.moderator_cache' => 'phpbb_discussions_moderator_cache',
            'tables.modules' => 'phpbb_discussions_modules',
            'tables.notification_emails' => 'phpbb_discussions_notification_emails',
            'tables.notification_types' => 'phpbb_discussions_notification_types',
            'tables.notifications' => 'phpbb_discussions_notifications',
            'tables.poll_options' => 'phpbb_discussions_poll_options',
            'tables.poll_votes' => 'phpbb_discussions_poll_votes',
            'tables.posts' => 'phpbb_discussions_posts',
            'tables.privmsgs' => 'phpbb_discussions_privmsgs',
            'tables.privmsgs_folder' => 'phpbb_discussions_privmsgs_folder',
            'tables.privmsgs_rules' => 'phpbb_discussions_privmsgs_rules',
            'tables.privmsgs_to' => 'phpbb_discussions_privmsgs_to',
            'tables.profile_fields' => 'phpbb_discussions_profile_fields',
            'tables.profile_fields_data' => 'phpbb_discussions_profile_fields_data',
            'tables.profile_fields_options_language' => 'phpbb_discussions_profile_fields_lang',
            'tables.profile_fields_language' => 'phpbb_discussions_profile_lang',
            'tables.ranks' => 'phpbb_discussions_ranks',
            'tables.reports' => 'phpbb_discussions_reports',
            'tables.reports_reasons' => 'phpbb_discussions_reports_reasons',
            'tables.search_results' => 'phpbb_discussions_search_results',
            'tables.search_wordlist' => 'phpbb_discussions_search_wordlist',
            'tables.search_wordmatch' => 'phpbb_discussions_search_wordmatch',
            'tables.sessions' => 'phpbb_discussions_sessions',
            'tables.sessions_keys' => 'phpbb_discussions_sessions_keys',
            'tables.sitelist' => 'phpbb_discussions_sitelist',
            'tables.smilies' => 'phpbb_discussions_smilies',
            'tables.sphinx' => 'phpbb_discussions_sphinx',
            'tables.styles' => 'phpbb_discussions_styles',
            'tables.styles_template' => 'phpbb_discussions_styles_template',
            'tables.styles_template_data' => 'phpbb_discussions_styles_template_data',
            'tables.styles_theme' => 'phpbb_discussions_styles_theme',
            'tables.styles_imageset' => 'phpbb_discussions_styles_imageset',
            'tables.styles_imageset_data' => 'phpbb_discussions_styles_imageset_data',
            'tables.teampage' => 'phpbb_discussions_teampage',
            'tables.topics' => 'phpbb_discussions_topics',
            'tables.topics_posted' => 'phpbb_discussions_topics_posted',
            'tables.topics_track' => 'phpbb_discussions_topics_track',
            'tables.topics_watch' => 'phpbb_discussions_topics_watch',
            'tables.user_group' => 'phpbb_discussions_user_group',
            'tables.user_notifications' => 'phpbb_discussions_user_notifications',
            'tables.users' => 'phpbb_discussions_users',
            'tables.warnings' => 'phpbb_discussions_warnings',
            'tables.words' => 'phpbb_discussions_words',
            'tables.zebra' => 'phpbb_discussions_zebra',
            ...
            'tables' => [
                'acl_groups' => 'phpbb_discussions_acl_groups',
                'acl_options' => 'phpbb_discussions_acl_options',
                'acl_roles' => 'phpbb_discussions_acl_roles',
                'acl_roles_data' => 'phpbb_discussions_acl_roles_data',
                'acl_users' => 'phpbb_discussions_acl_users',
                'attachments' => 'phpbb_discussions_attachments',
                'auth_provider_oauth_token_storage' => 'phpbb_discussions_oauth_tokens',
                'auth_provider_oauth_states' => 'phpbb_discussions_oauth_states',
                'auth_provider_oauth_account_assoc' => 'phpbb_discussions_oauth_accounts',
                'banlist' => 'phpbb_discussions_banlist',
                'bbcodes' => 'phpbb_discussions_bbcodes',
                'bookmarks' => 'phpbb_discussions_bookmarks',
                'bots' => 'phpbb_discussions_bots',
                'captcha_qa_questions' => 'phpbb_discussions_captcha_questions',
                'captcha_qa_answers' => 'phpbb_discussions_captcha_answers',
                'captcha_qa_confirm' => 'phpbb_discussions_qa_confirm',
                'config' => 'phpbb_discussions_config',
                'config_text' => 'phpbb_discussions_config_text',
                'confirm' => 'phpbb_discussions_confirm',
                'disallow' => 'phpbb_discussions_disallow',
                'drafts' => 'phpbb_discussions_drafts',
                'ext' => 'phpbb_discussions_ext',
                'extensions' => 'phpbb_discussions_extensions',
                'extension_groups' => 'phpbb_discussions_extension_groups',
                'forums' => 'phpbb_discussions_forums',
                'forums_access' => 'phpbb_discussions_forums_access',
                'forums_track' => 'phpbb_discussions_forums_track',
                'forums_watch' => 'phpbb_discussions_forums_watch',
                'groups' => 'phpbb_discussions_groups',
                'icons' => 'phpbb_discussions_icons',
                'lang' => 'phpbb_discussions_lang',
                'log' => 'phpbb_discussions_log',
                'login_attempts' => 'phpbb_discussions_login_attempts',
                'migrations' => 'phpbb_discussions_migrations',
                'moderator_cache' => 'phpbb_discussions_moderator_cache',
                'modules' => 'phpbb_discussions_modules',
                'notification_emails' => 'phpbb_discussions_notification_emails',
                'notification_types' => 'phpbb_discussions_notification_types',
                'notifications' => 'phpbb_discussions_notifications',
                'poll_options' => 'phpbb_discussions_poll_options',
                'poll_votes' => 'phpbb_discussions_poll_votes',
                'posts' => 'phpbb_discussions_posts',
                'privmsgs' => 'phpbb_discussions_privmsgs',
                'privmsgs_folder' => 'phpbb_discussions_privmsgs_folder',
                'privmsgs_rules' => 'phpbb_discussions_privmsgs_rules',
                'privmsgs_to' => 'phpbb_discussions_privmsgs_to',
                'profile_fields' => 'phpbb_discussions_profile_fields',
                'profile_fields_data' => 'phpbb_discussions_profile_fields_data',
                'profile_fields_options_language' => 'phpbb_discussions_profile_fields_lang',
                'profile_fields_language' => 'phpbb_discussions_profile_lang',
                'ranks' => 'phpbb_discussions_ranks',
                'reports' => 'phpbb_discussions_reports',
                'reports_reasons' => 'phpbb_discussions_reports_reasons',
                'search_results' => 'phpbb_discussions_search_results',
                'search_wordlist' => 'phpbb_discussions_search_wordlist',
                'search_wordmatch' => 'phpbb_discussions_search_wordmatch',
                'sessions' => 'phpbb_discussions_sessions',
                'sessions_keys' => 'phpbb_discussions_sessions_keys',
                'sitelist' => 'phpbb_discussions_sitelist',
                'smilies' => 'phpbb_discussions_smilies',
                'sphinx' => 'phpbb_discussions_sphinx',
                'styles' => 'phpbb_discussions_styles',
                'styles_template' => 'phpbb_discussions_styles_template',
                'styles_template_data' => 'phpbb_discussions_styles_template_data',
                'styles_theme' => 'phpbb_discussions_styles_theme',
                'styles_imageset' => 'phpbb_discussions_styles_imageset',
                'styles_imageset_data' => 'phpbb_discussions_styles_imageset_data',
                'teampage' => 'phpbb_discussions_teampage',
                'topics' => 'phpbb_discussions_topics',
                'topics_posted' => 'phpbb_discussions_topics_posted',
                'topics_track' => 'phpbb_discussions_topics_track',
                'topics_watch' => 'phpbb_discussions_topics_watch',
                'user_group' => 'phpbb_discussions_user_group',
                'user_notifications' => 'phpbb_discussions_user_notifications',
                'users' => 'phpbb_discussions_users',
                'warnings' => 'phpbb_discussions_warnings',
                'words' => 'phpbb_discussions_words',
                'zebra' => 'phpbb_discussions_zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'phpbb_discussions_',
